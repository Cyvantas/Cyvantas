 ...
 * opacity-only — or nothing — for users who request reduced motion, so no
 * per-component guard is needed here.
 *
 * - Reveal: single block, fades up when scrolled into view (once).
 * - Stagger: container that orchestrates staggered children.
 * - StaggerItem: child of Stagger; inherits the parent's timeline.
 */
